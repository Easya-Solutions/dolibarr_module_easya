...
/**
 * 	\defgroup   easya     Module easya
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/easya/core/modules directory.
 *  \file       htdocs/easya/core/modules/modeasya.class.php
 *  \ingroup    easya
 *  \brief      Description and activation file for module easya
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module easya
 */
class modeasya extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->const [$r] [2] = trim(file_get_contents(DOL_DOCUMENT_ROOT.'/VERSION'));
		$this->const [$r] [3] = 0;
		$this->const [$r] [4] = 0;
		$this->const [$r] [5] = 'all';
		$this->const [$r] [6] = 1;
        ...
        // Font awesome 6
        $r ++;
        $this->const [$r] [0] = "MAIN_FONTAWESOME_DIRECTORY";
        $this->const [$r] [1] = "chaine";
        ...
        $r ++;
        $this->const [$r] [0] = "MAIN_FONTAWESOME_FAMILY";
        $this->const [$r] [1] = "chaine";
        ...
        // Activate icon style Font awesome 6 light by default
        $r ++;
        $this->const [$r] [0] = "MAIN_FONTAWESOME_ICON_STYLE";
        $this->const [$r] [1] = "chaine";
        $this->const [$r] [2] = "fal";
        $this->const [$r] [3] = 0;
        $this->const [$r] [4] = 0;
        ...
        $r ++;
        $this->const [$r] [0] = "MAIN_FONTAWESOME_WEIGHT";
        $this->const [$r] [1] = "chaine";
        $this->const [$r] [2] = "300";
        $this->const [$r] [3] = 0;
        $this->const [$r] [4] = 0;
        ...
        // InfraSpackPlus generates HTTP 500 errors
        $r ++;
        $this->const [$r] [0] = "INFRASPACKPLUS_DISABLED_CORE_CHANGE";
        $this->const [$r] [1] = "chaine";
        $this->const [$r] [2] = "1";
        ...
        $r ++;
        $this->const [$r] [0] = "INFRASPACKPLUS_DISABLED_MODULE_CHANGE";
        $this->const [$r] [1] = "chaine";
        $this->const [$r] [2] = "1";
        ...
        // Don't show Dolibarr version in top right by default
        $r ++;
        $this->const [$r] [0] = "OBLYON_DISABLE_VERSION";
        $this->const [$r] [1] = "chaine";
        $this->const [$r] [2] = "1";
        $this->const [$r] [3] = 0;
        $this->const [$r] [4] = 0;
	...
	public function remove($options = '')
	{
		...
		dolibarr_del_const($this->db,'MAIN_FONTAWESOME_ICON_STYLE');
